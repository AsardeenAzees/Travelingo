...
export default function DestinationCard({ title, location, rating, image }) {
  return (
    <div className="rounded-[26px] shadow bg-white relative overflow-hidden w-62 h-80 hover:shadow-md cursor-pointer transition-transform transform hover:-translate-y-1">
