...
export default function DashboardPage() {
  ...
  // Render reusable sidebar content
  ...
  return (
    <div className="flex flex-col lg:flex-row bg-white min-h-screen font-sans">
      ...
      <div
        className={`fixed inset-0 z-40 bg-black bg-opacity-40 transition-opacity ${isSidebarOpen ? "opacity-100 visible" : "opacity-0 invisible"
          }`}
      ...
      <aside
        className={`fixed top-0 left-0 z-50 h-full w-[270px] bg-white shadow-lg transform transition-transform duration-300 ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"
          } lg:hidden p-6 pt-12`}
      >
      ...
      <main className="flex-1 mt-[60px] lg:mt-[30px]">
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-6 mb-10 px-4">
          ...
          {/*Mobile Bell Notification (Top Right)*/}
          ...
          <div className="w-full lg:max-w-[75%] bg-[#F4F8F7] rounded-[44px] shadow-xl p-4 sm:p-6 lg:p-8">
            <section className="w-full">
              ...
              <div className="flex flex-col lg:flex-row items-center lg:items-start justify-center lg:justify-between gap-4 mb-8">
                ...
                {/* Search + Bell on same row for desktop view */}
                <div className="flex flex-col lg:flex-row lg:items-center lg:gap-4 w-full lg:w-auto">
                  {/* Search bar */}
                  <form className="relative w-full max-w-xs lg:w-[282px] h-[48px]">
                    <input
                      type="text"
                  ...
                  {/* Desktop Bell icon */}
                  <div className="relative hidden sm:flex mt-4 lg:mt-0">
                    <button
          ...
          {/* Sidebar: Profile + Calendar + Schedule */}
